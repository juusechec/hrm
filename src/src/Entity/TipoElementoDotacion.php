...
/**
 * TipoElementoDotacion
 *
 * @ORM\Table(name="tipo_elemento_dotacion")
 * @ORM\Entity
 */
class TipoElementoDotacion
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="tipo_elemento_dotacion_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
