 ...
 * TipoAuxilioContrato
 *
 * @ORM\Table(name="tipo_auxilio_contrato")
 * @ORM\Entity
 */
class TipoAuxilioContrato
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="tipo_auxilio_contrato_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
